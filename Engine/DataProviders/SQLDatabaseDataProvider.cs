...
{
    public class SQLDatabaseDataProvider : DataProviderBase, IDataProvider
    {
        public ISQLServerInfoFactory SqlServerInfoFactory { get; }

        public SQLDatabaseDataProvider(ISQLServerInfoFactory sqlServerInfoFactory, DataProvider dataProvider, ILoggerFactory loggerFactory) : base(dataProvider, loggerFactory)
        {
