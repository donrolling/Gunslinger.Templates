...
namespace Gunslinger.Factories.SQL
{
	public class ViewInfoFactory
	{
		...
		public static IEnumerable<View> Create(SQLServerInfo sqlServerInfo, GenerationSettings settings, List<string> includeTheseEntitiesOnly, List<string> excludeTheseEntities)
		{
