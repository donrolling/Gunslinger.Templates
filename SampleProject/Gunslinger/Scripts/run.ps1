$projectDirectory = 'C:\Projects\idi.utilities\Gunslinger.Templates\SampleProject\'
...
$outputPath = 'C:\Projects\idi.utilities\Gunslinger.Templates\SampleProject'
$templatesPath = 'C:\Projects\idi.utilities\Gunslinger.Templates\SampleProject\Gunslinger\Templates'
$processTemplateStubs = 'true'
######################################################################################################
# DAC Config #########################################################################################
######################################################################################################
$dacpacScriptPath = $pathToScripts + 'DeployViaDAC.ps1'
$dacpacFilePath = $projectDirectory + 'idi.sample.database\bin\Debug\idi.sample.database.dacpac'
$sqlPackagePath = 'C:\SQLPackage\Microsoft.SqlServer.Dac.dll'
$sqlServerName = 'localhost'
$databaseName = 'idi_sample'
######################################################################################################
# Ad-Hoc SQL Config ##################################################################################
######################################################################################################
